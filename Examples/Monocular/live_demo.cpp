...
int main(int argc, char **argv)
{
    ...
    ORB_SLAM2::System SLAM(argv[1],argv[2],ORB_SLAM2::System::MONOCULAR,true,0); // argv[1] is the vocabulary file and argv[2] is the settings file
    cv::Mat frame;
