...
void RunDemo() {
    ...
    NDArray masks = exec->outputs[3].Copy(Context(kCPU,0));
    LOG(INFO) << "mask size "<<masks.Size();
    LOG(INFO) << "id size "<<ids.Size();
    auto shape = masks.GetShape();
    for (auto s:shape)
    {
        LOG(INFO)<<s;
    }
    ...
    // draw boxes
    auto plt = viz::PlotBbox(image, bboxes, scores, ids,masks, args::viz_thresh, synset::CLASS_NAMES, std::map<int, cv::Scalar>(), !args::quite);
...
//ParseArgs(argc, argv);
    args::model = "/home/zuoxin/workspace/project/ORB_SLAM2_PLUS/Examples/RGB-D/mask_rcnn_resnet18_v1b_tum";
    //args::model = "/home/zuoxin/workspace/project/ORB_SLAM2_PLUS/Examples/RGB-D/mask_rcnn_resnet50_v1b_coco";
    args::image = "/home/zuoxin/workspace/project/ORB_SLAM2_PLUS/data/rgbd_dataset_freiburg2_desk/rgbd_dataset_freiburg2_desk/rgb/1311868164.831006.png";
    args::gpu = 0;
    args::min_size = 400;
    args::max_size = 600;
    args::viz_thresh = 0.4;
